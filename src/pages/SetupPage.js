...
const SetupPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen h-full items-center justify-center pb-28 bg-gradient-to-b from-white to-primary/35">
      <div className="flex flex-col w-full max-w-[85%] mx-auto">
        ...
        >
          <div className="flex flex-col mb-4">
            <label className="text-primary font-bold pb-2">Company Name*</label>
            <input
              type="text"
          ...
          <button
            ...
            className="w-full p-2 bg-secondary text-white text-lg font-semibold rounded-lg shadow-lg hover:bg-primary transition-all duration-300"
          >
            ...
            <div className="bg-white p-6 rounded-lg w-4/5 max-w-3xl animate__animated animate__fadeIn">
              ...
              <ul className="space-y-2">
                {selectedPage.dataChunks.length ? (
                  selectedPage.dataChunks.map((chunk, idx) => (
                    <li
                      key={idx}
                      className="bg-secondary text-white px-4 py-2 rounded-lg shadow-lg"
                    >
                      {chunk}
                    </li>
                  ))
              ...
              <div className="mt-4 text-center">
                <button
                  ...
                  className="p-2 bg-secondary text-white font-semibold rounded-lg hover:bg-primary transition-all duration-300"
                >
                  Close
                </button>
              </div>
